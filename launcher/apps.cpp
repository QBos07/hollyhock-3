...
const Elf32_Ehdr *Apps::LoadELF(File f, const Elf32_Shdr **sectionHeaders) {
...
void Apps::LoadApp(const char *folder, wchar_t *fileName) {
	struct AppInfo app;
...
void Apps::LoadAppInfo() {
	static const char *const HHK_FOLDER[] = {
		"\\fls0\\",
		"\\drv0\\"
	};
...
Apps::EntryPoint Apps::RunApp(int i) {
